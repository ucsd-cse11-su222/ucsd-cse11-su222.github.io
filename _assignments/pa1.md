...
### Due Date: Monday, August 8, 10:00PM Pacific Time
...
If you get stuck at any point, do any one of the following:
  ...
  - [Ask for help!](https://ucsd-cse11-su222.github.io/staff-and-help.html)

## Running Code

Download the starter code for this assignment by downloading this repository
using the “Download ZIP” button:
[https://github.com/ucsd-cse11-su222/cse11-pa1-starter](https://github.com/ucsd-cse11-su222/cse11-pa1-starter)
...
1. A code submission of your program with the methods you wrote for part two, at [PA1 gradescope assignment](https://www.gradescope.com/courses/412088/assignments/2145422/). You should select and upload the files `DesignRecipeExamples.java` and `transcript.txt`
